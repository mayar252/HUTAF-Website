...
const Home = () => {
  ...
  const featuredTech = [
    ...
    },
    {
      title: "AI Coach",
      description:
        "Your personal AI tactical coach providing real-time formation analysis, player development insights, and match strategy recommendations.",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      title: "AI Chat",
      description:
        "Interactive AI assistant for real-time football discussions, tactical analysis, and match insights. Get instant answers to your football questions.",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      title: "Analysis",
      description:
        "Comprehensive match analysis tools with advanced statistics, performance metrics, and predictive insights for better decision-making.",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
